# 1 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.c" 2
# 1 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.h" 1




# 1 "canlib/dspic33epxxxgp50x/../can.h" 1
...
# 9 "canlib/dspic33epxxxgp50x/../can.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c99\\stdbool.h" 1 3
# 10 "canlib/dspic33epxxxgp50x/../can.h" 2
...
# 5 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.h" 2
# 16 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.h"
void init_can(const can_timing_t *timing,
              void (*receive_callback)(const can_msg_t *message),
              _Bool run_in_loopback);
...
# 10 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c99\\stdlib.h" 3
...
# 2 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.c" 2
...
static unsigned int can_msg_buf[32][8] __attribute__((aligned(32 * 16)));
...
# 264 "canlib/dspic33epxxxgp50x/dspic33epxxxgp50x_can.c"
static void init_filters_and_masks(void) {

    C1RXM0SID = 0;


    do { C1FMSKSEL1bits.F0MSK = 0; C1RXF0SID = 0; C1BUFPNT1bits.F0BP = ((0)+1); } while(0);
    do { C1FMSKSEL1bits.F1MSK = 0; C1RXF1SID = 0; C1BUFPNT1bits.F1BP = ((1)+1); } while(0);
    do { C1FMSKSEL1bits.F2MSK = 0; C1RXF2SID = 0; C1BUFPNT1bits.F2BP = ((2)+1); } while(0);
    do { C1FMSKSEL1bits.F3MSK = 0; C1RXF3SID = 0; C1BUFPNT1bits.F3BP = ((3)+1); } while(0);
}
