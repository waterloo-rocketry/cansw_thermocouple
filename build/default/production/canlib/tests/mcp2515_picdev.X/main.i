# 1 "canlib/tests/mcp2515_picdev.X/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "canlib/tests/mcp2515_picdev.X/main.c" 2
# 24 "canlib/tests/mcp2515_picdev.X/main.c"
...
# 24 "canlib/tests/mcp2515_picdev.X/main.c" 2

# 1 "canlib/tests/mcp2515_picdev.X/../../mcp2515/mcp_2515.h" 1



# 1 "canlib/tests/mcp2515_picdev.X/../../mcp2515/../can.h" 1
# 16 "canlib/tests/mcp2515_picdev.X/../../mcp2515/../can.h"
typedef struct {
...
# 4 "canlib/tests/mcp2515_picdev.X/../../mcp2515/mcp_2515.h" 2
...
# 25 "canlib/tests/mcp2515_picdev.X/main.c" 2

# 1 "canlib/tests/mcp2515_picdev.X/spi.h" 1
...
# 26 "canlib/tests/mcp2515_picdev.X/main.c" 2
# 38 "canlib/tests/mcp2515_picdev.X/main.c"
void main(void)
{

    SYSTEM_Initialize();

    do{ _delay((unsigned long)((50)*(48000000/4000.0))); do{LATC4 = 0;}while(0); do{LATC5 = 0;}while(0); _delay((unsigned long)((100)*(48000000/4000.0))); do{LATC4 = 1;}while(0); do{LATC5 = 1;}while(0);}while(0);
